...
- [Установка](#установка)
  ...
  - [Доступ к админ-панелям](#доступ-к-админ-панелям)
    - [HTTPS](#https)
      - [Собственные сайты на портах 80 и 443](#собственные-сайты-на-портах-80-и-443)
...
#### Собственные сайты на портах 80 и 443
...
Caddy будет принимать запросы к `example.com` на портах 80 и 443, автоматически перенаправлять HTTP на HTTPS и управлять TLS-сертификатом. Домен должен указывать на сервер, а сервис `my-app` должен быть доступен контейнеру `https` в общей Docker-сети.
